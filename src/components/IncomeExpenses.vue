...
<template>
  <div class="flex justify-between items-center w-full mt-8 bg-black rounded-lg p-4">
    ...
    <div class="w-1/2 text-center">
      ...
      <p id="money-minus" class="text-3xl mt-3 font-extrabold text-red-500">-${{ expenses }}</p>
    </div>
  </div>
</template>
